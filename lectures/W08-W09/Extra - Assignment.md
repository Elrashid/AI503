...
**Objective:**  
The aim of this assignment is to design, train, and evaluate a **Convolutional Neural Network (CNN)** for classifying images from a large image dataset. Students will explore image preprocessing, CNN architecture design, model training, evaluation, and performance analysis.
...
In addition, students must perform an **architecture comparison** by gradually increasing the number of hidden layers in the CNN model and evaluating the performance each time.

Students should train and compare at least **three CNN architectures**:
...
For each model, students should report:
