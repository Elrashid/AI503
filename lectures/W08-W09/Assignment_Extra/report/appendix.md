# Appendix - numeric confusion matrices and worked metric calculation

## Confusion matrix (counts): Ensemble: Stacking (LogReg)

| true \\ pred | airplane | automobile | bird | cat | deer | dog | frog | horse | ship | truck |
|---|---|---|---|---|---|---|---|---|---|---|
| **airplane** | 960 | 4 | 4 | 1 | 1 | 1 | 1 | 2 | 21 | 5 |
| **automobile** | 6 | 965 | 0 | 1 | 0 | 0 | 0 | 1 | 2 | 25 |
...
## Confusion matrix (counts): Ensemble: Soft-Vote (top3)

| true \\ pred | airplane | automobile | bird | cat | deer | dog | frog | horse | ship | truck |
|---|---|---|---|---|---|---|---|---|---|---|
| **airplane** | 945 | 4 | 5 | 2 | 3 | 0 | 1 | 3 | 31 | 6 |
| **automobile** | 6 | 960 | 0 | 1 | 0 | 0 | 1 | 1 | 1 | 30 |
...
## Confusion matrix (counts): Ensemble: Hard-Vote (top3)

| true \\ pred | airplane | automobile | bird | cat | deer | dog | frog | horse | ship | truck |
|---|---|---|---|---|---|---|---|---|---|---|
| **airplane** | 941 | 5 | 6 | 2 | 5 | 0 | 1 | 2 | 33 | 5 |
| **automobile** | 10 | 961 | 0 | 1 | 0 | 0 | 1 | 1 | 2 | 24 |
...
## Worked example - how the per-class metrics are calculated
